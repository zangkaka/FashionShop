...
import rang.com.fashionshop.home.HomeActivity;
...
public class SliderLayout extends RelativeLayout {
    ...
    public void setCustomIndicator(PagerIndicator indicator) {
        ...
        mIndicator.setDefaultIndicatorShape(PagerIndicator.Shape.Rectangle);
        mIndicator.setDefaultIndicatorSize(10, 3, PagerIndicator.Unit.DP);
        mIndicator.redraw();
    }
